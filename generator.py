...
# Generator 패턴
# 1. 지능형 리스트, 딕셔너리, 집합-> 데이터셋이 증가 될 경우 메모리 사용량 증가 -> 제네레이터 완화
...
# 조건 
print()
gen2 = itertools.takewhile(lambda n : n < 30, itertools.count(1, 2.5))
...
gen9 = itertools.groupby('AAAAABBBBBBCCCCCCCDDDDDDEEAAAE')
