...
# Future 동시성
# 비동기 작업 실행
# 지연시간(block) cpu및 리소스 낭비 방지 -> Network I/O 관련작업 동시성 활용 권장
...
# 초기 CSV 위치
TARGET_CSV = '/Users/sdk/advanced-python/python_hard/resources/nations.csv' # 본인 경로 변경
# 저장 폴더 위치
DEST_DIR = '/Users/sdk/advanced-python/python_hard/csvs' # 본인 경로 변경
# CSV 헤더 기초 정보
